...
export const commonObject = {
  ...
  export const popupButtonClose = document.querySelector(".popup__button_type_close");
...
export const popupButtonExit = document.querySelector(".popup__button_type_exit");
...
export const popupButtonSave = document.querySelector(".popup__button_type_save");
